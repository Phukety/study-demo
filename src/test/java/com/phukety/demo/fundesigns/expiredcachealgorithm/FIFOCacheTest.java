...
public class FIFOCacheTest {
    ...
    public void testFIFOCache() {
        FIFOCache<String> cache = new FIFOCache<>(5);
    ...
    @Test
    public void testExpiredFIFOCache() throws InterruptedException {
        FIFOCache<String> cache = new FIFOCache<>(5);
    ...
    public void testBoundary() {
        FIFOCache<String> cache = new FIFOCache<>();
        int i = 0;
    ...
    public void testGenerics() throws InterruptedException, ExecutionException {
        FIFOCache<Integer> integerCache = new FIFOCache<>();
        ...
        FIFOCache<ExecutorService> executorCache = new FIFOCache<>();
